...
namespace _42.Platform.Sdk.Api
{
    ...
    public interface IAccessApiSync : IApiAccessor
    {
        ...
        MachineAccess CreateMachineAccess(string organization, string project, MachineAccessCreate? machineAccessCreate = default(MachineAccessCreate?), int operationIndex = 0);
        ...
        ApiResponse<MachineAccess> CreateMachineAccessWithHttpInfo(string organization, string project, MachineAccessCreate? machineAccessCreate = default(MachineAccessCreate?), int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <exception cref="_42.Platform.Sdk.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    public interface IAccessApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<MachineAccess> CreateMachineAccessAsync(string organization, string project, MachineAccessCreate? machineAccessCreate = default(MachineAccessCreate?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<MachineAccess>> CreateMachineAccessWithHttpInfoAsync(string organization, string project, MachineAccessCreate? machineAccessCreate = default(MachineAccessCreate?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
    ...
    public partial class AccessApi : IAccessApi
    {
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>MachineAccess</returns>
        public MachineAccess CreateMachineAccess(string organization, string project, MachineAccessCreate? machineAccessCreate = default(MachineAccessCreate?), int operationIndex = 0)
        {
            _42.Platform.Sdk.Client.ApiResponse<MachineAccess> localVarResponse = CreateMachineAccessWithHttpInfo(organization, project, machineAccessCreate);
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of MachineAccess</returns>
        public _42.Platform.Sdk.Client.ApiResponse<MachineAccess> CreateMachineAccessWithHttpInfo(string organization, string project, MachineAccessCreate? machineAccessCreate = default(MachineAccessCreate?), int operationIndex = 0)
        {
            // verify the required parameter 'organization' is set
            if (organization == null)
            {
                throw new _42.Platform.Sdk.Client.ApiException(400, "Missing required parameter 'organization' when calling AccessApi->CreateMachineAccess");
            }

            // verify the required parameter 'project' is set
            if (project == null)
            {
                throw new _42.Platform.Sdk.Client.ApiException(400, "Missing required parameter 'project' when calling AccessApi->CreateMachineAccess");
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of MachineAccess</returns>
        public async System.Threading.Tasks.Task<MachineAccess> CreateMachineAccessAsync(string organization, string project, MachineAccessCreate? machineAccessCreate = default(MachineAccessCreate?), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            _42.Platform.Sdk.Client.ApiResponse<MachineAccess> localVarResponse = await CreateMachineAccessWithHttpInfoAsync(organization, project, machineAccessCreate, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
