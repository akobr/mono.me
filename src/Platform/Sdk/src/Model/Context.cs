...
namespace _42.Platform.Sdk.Model
{
    ...
    public partial class Context : IValidatableObject
    {
        ...
        /// <param name="annotationType">annotationType (default to AnnotationTypeEnum.Context).</param>
