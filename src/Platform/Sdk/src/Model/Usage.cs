...
namespace _42.Platform.Sdk.Model
{
    ...
    public partial class Usage : IValidatableObject
    {
        ...
        /// <param name="annotationType">annotationType (default to AnnotationTypeEnum.Usage).</param>
        ...
        public Usage(string subjectKey = default(string), string responsibilityKey = default(string), string subjectName = default(string), string responsibilityName = default(string), List<string> executions = default(List<string>), AnnotationTypeEnum? annotationType = AnnotationTypeEnum.Usage, string title = default(string), string description = default(string), string documentationLink = default(string), bool? isDisabled = default(bool?), DateTime? validFrom = default(DateTime?), DateTime? expiresAt = default(DateTime?), string varTimeZone = default(string), List<string> labels = default(List<string>), Dictionary<string, Object> values = default(Dictionary<string, Object>), string partitionKey = default(string), string id = default(string), string projectName = default(string), string viewName = default(string), string annotationKey = default(string), string name = default(string))
        {
