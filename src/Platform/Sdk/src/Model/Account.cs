...
namespace _42.Platform.Sdk.Model
{
    ...
    public partial class Account : IValidatableObject
    {
        ...
        public Account(string id = default(string), string userName = default(string), string name = default(string), Dictionary<string, InnerEnum> accessMap = default(Dictionary<string, InnerEnum>))
        {
            this.Id = id;
