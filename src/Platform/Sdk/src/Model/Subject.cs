...
namespace _42.Platform.Sdk.Model
{
    ...
    public partial class Subject : IValidatableObject
    {
        ...
        /// <param name="annotationType">annotationType (default to AnnotationTypeEnum.Subject).</param>
