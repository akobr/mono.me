...
public class CertificatesHttp
{
    ...
    [OpenApiSecurity(Definitions.SecuritySchemas.Mtls, SecuritySchemeType.Http, Scheme = OpenApiSecuritySchemeType.Bearer, Description = "Machine certificate authentication.")]
