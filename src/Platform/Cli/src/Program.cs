...
#endif
            .UseCommandLineApplication<PlatformCommand>(args, ConfigureConsoleApplication)
            .UseStartup<Startup>();
    }

    private static void ConfigureConsoleApplication(CommandLineApplication<PlatformCommand> application)
    {
