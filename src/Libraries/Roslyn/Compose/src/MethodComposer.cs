...
namespace _42.Roslyn.Compose
{
    public class MethodComposer : MethodSelector<MethodComposer>, IComposer
    {
        ...
        public MethodComposer(MethodDeclarationSyntax method, IComposer parent)
            : base(method)
        {
            Composer = this;
        ...
        public MethodComposer(MethodDeclarationSyntax node)
            : base(node)
        {
        }

        public MethodComposer(List<MethodDeclarationSyntax> nodes)
            : base(nodes)
        {
        }
